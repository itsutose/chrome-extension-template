...
2. **006**: テキスト選択・メモ復元位置特定のテスト環境構築
3. **002-A**: メモ復元位置特定アルゴリズムの実装
4. **002-B**: メモ表示UI（Google Keepライク）の実装
5. **003**: メモ編集・保存機能の実装
6. **004**: メモの永続化・復元機能の実装
7. **005**: メモ機能の統合・最適化
...
- 2025-01-XX: 006番のissueを追加（テスト環境構築）
- 2025-01-XX: 002番のissueを002-A（復元アルゴリズム）と002-B（UI実装）に分割 